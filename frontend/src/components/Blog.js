                        ...
                        <div class="row d-flex">
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_1.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Những loại cây xanh thích hợp đặt trong phòng ngủ</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                                        </div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_2.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">5 tips giúp bắt đầu một ngày mới với tâm trạng tích cực</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_3.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Cải tạo phòng ngủ - Nên bắt đầu từ đâu?</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_4.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Khám phá khung giờ học tập giúp bạn tiếp thu bài hiệu quả nhất</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_5.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Tự tay trang trí bàn học với những mẹo hay hữu ích</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_6.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Môi trường sống khác biệt kiến tạo nên cộng đồng cư dân ưu tú</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_7.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Aesthetic - Phong cách thời trang và lối sống mới của gen Z</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
                            ...
                            <div class="col-md-3 d-flex">
                                <div class="blog-entry justify-content-end">
                                    <div class="text">
                                        <Link to="blog-single.html" class="block-20 img" style={{ backgroundImage: `url('images/image_8.jpg')` }}>
                                        </Link>
                                        <h3 class="heading"><Link to="#">Mẹo trang trí giúp khai thác không gian căn hộ mini</Link></h3>
                                        <div class="meta mb-3">
                                            <div><Link to="#">June. 24, 2022</Link></div>
                                            <div><Link to="#">Admin</Link></div>
                                            <div><Link to="#" class="meta-chat"><span class="icon-chat"></span> 3</Link></div>
