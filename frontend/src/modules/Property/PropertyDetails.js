...
const PropertyDetails = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get(`${baseURL}/api/get-property/${propertyId}`)
        .then((response) => {
                ...
                >
                  ...
                  >
                    <li className="nav-item">
                      <Link
                        className={
                          toggle === 1 ? "nav-link active" : "nav-link"
                        }
                    ...
                    <li className="nav-item">
                      <Link
                        className={
                          toggle === 2 ? "nav-link active" : "nav-link"
                        }
                    ...
                    <li className="nav-item">
                      <Link
                        className={
                          toggle === 5 ? "nav-link active" : "nav-link"
                        }
                        id="pills-review-tab"
                        data-toggle="pill"
                        to="#"
                ...
                <div className="tab-content" id="pills-tabContent">
                  ...
                  >
                    <div className="itemWrapper playerActive">
                      <iframe
                        src={
                          "https://my.matterport.com/show/?model=AseRoob7d5G&amp;play=1"
                        }
